...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
	...
	if version >= 700
		...
		call <SID>X("PMenuSel", s:selection, s:vislines, "bold")
		call <SID>X("PMenuSbar", "", s:line, "")
		call <SID>X("PMenuThumb", "", s:vislines, "")
